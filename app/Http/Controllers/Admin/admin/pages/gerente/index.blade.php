        ...
        $(function(){
            ...
            $('body').on('keydown', 'input.comissao_paga_change', function(event) {
                if (event.key === 'Tab') {
                    ...
                    // Move o foco para o próximo campo de input
                    listarcomissaomesdfirente.cell(nextCellIndex.row, nextCellIndex.column).nodes().to$().find('input.comissao_paga_change').focus();
