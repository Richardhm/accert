...
class OrcamentoController extends Controller
{
    ...
    public function criarPDF(Request $request)
    {
        if(auth()->user()->corretora_id == 1) {
            return $this->pdfAccert($request);
        } else {
            return $this->pdfInnove($request);
        }
    ...
    private function pdfInnove($request)
    {
        $linha01 = "";
        $linha02 = "";
        $linha03 = "";
        ...
        ");
                ...
                $view = \Illuminate\Support\Facades\View::make("admin.pages.orcamento.pdf2-innove",[
                    "frase_consultor" => $frase_consultor,
                    "planos" => $dados,
                    "nome" => $nome,
                    "administradoras" => $administradora,
...
//                ->deleteFileAfterSend(true);
    ...
    private function pdfAccert($request)
    {
        $linha01 = "";
        $linha02 = "";
        $linha03 = "";
        ...
        ");
            ...
            $co = ConfigurarCoparticipacao::where("tabela_origens_id",$request->tabela_origem)->where("plano_id",$request->plano_id)->first();
            ...
            if($co) {
                ...
                $linha02 = $co->linha02;
                $linha03 = $co->linha03;
                $consultas_eletivas = $co->consultas_eletivas;
                $consultas_de_urgencia = $co->consultas_urgencia;
                $exames_simples = $co->exames_simples;
                $exames_complexos = $co->exames_complexos;
                $terapias = $co->terapias;
            }
